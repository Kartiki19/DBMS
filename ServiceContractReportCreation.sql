...
SELECT CustID CUSTOMER# FROM Service_Contract WHERE ContractID = &1;

COLUMN CUSTOMER_NAME NEW_VALUE Name
SELECT Name CUSTOMER_NAME 
FROM Customer 
JOIN Service_Contract ON Service_Contract.CustID = Customer.CustID
WHERE ContractID = &1;

-- Title as the Company Name
TTITLE CENTER "Magic Wand Inc." skip 1 -
CENTER ============================================================================== SKIP 2 -
LEFT "Service Contract ID : " &1 RIGHT "Date : " report_date skip 1 -
LEFT "Customer ID : " CustID RIGHT "Customer Name : " Name skip 3
...
select 'ServiceContract_' || &1 || '_' || to_char(sysdate, 'yyyymmdd') || '.txt' ReportFilename from dual;
...
SELECT Service_Contract.ServiceItemID, ServiceItems.TypeOfService, 
...
WHERE Service_Contract.ContractID = &1;
